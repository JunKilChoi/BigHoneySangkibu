...
MID_APP_TITLE = "🍯 중학교 간편 생기부 문장 생성 v50"
MID_APP_SUBTITLE = "활동·관찰 영역과 성취수준을 바탕으로 비슷하지만 조금씩 다른 문장을 생성합니다 · patched-20260621-v50-mid"
MID_APP_VERSION = "patched-20260621-v50-mid"
...
def build_mid_sample_project():
    ...
    return {
        ...
        "saved_at": datetime.now().isoformat(timespec="seconds"),
        "app": "개꿀 생기부 - 중학교 간편 생성기",
        "version": "sample-mid-project-v50",
    }
...
with st.sidebar:
    ...
    if st.button("중학교 페이지 전체 초기화", type="secondary"):
        for key in ["mid_settings", "mid_areas", "mid_results", "mid_student_rows"]:
